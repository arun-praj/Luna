      ...
      <div className="mx-auto w-full max-w-[720px] px-4 pb-12 sm:px-5">
        ...
        {isLoading ? <div className="mt-10 flex min-h-60 items-center justify-center text-sm text-muted-foreground">Loading instrument…</div> : <>
          <section className="mt-6 border-y border-border py-6 text-center">
            <div className="mx-auto flex size-16 items-center justify-center overflow-hidden rounded-[18px] border border-border" style={{ backgroundColor: selectedBackground }}><Image src={previewIcon} alt="" width={64} height={64} className="size-full object-cover" unoptimized /></div>
