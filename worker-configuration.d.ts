/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 45fedc3857e2733afd468bfa387ae71f)
// Runtime types generated with workerd@1.20260801.1 2026-08-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	R2: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	APP_URL: "https://luna.arunprajapati.com";
	WEBAUTHN_RP_ID: "luna.arunprajapati.com";
	AUTH_JWT_SECRET: string;
	AUTH_ENCRYPTION_KEY: string;
	CRON_SECRET: string;
	NVIDIA_AI_API_KEY: string;
	NVIDIA_AI_API_URL: string;
	NVIDIA_AI_MODEL: string;
	REPORT_MONTHLY_HOUR: string;
	SMTP_HOST: string;
	SMTP_PORT: string;
	SMTP_SECURE: string;
	SMTP_USER: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "WEBAUTHN_RP_ID" | "AUTH_JWT_SECRET" | "AUTH_ENCRYPTION_KEY" | "CRON_SECRET" | "NVIDIA_AI_API_KEY" | "NVIDIA_AI_API_URL" | "NVIDIA_AI_MODEL" | "REPORT_MONTHLY_HOUR" | "SMTP_HOST" | "SMTP_PORT" | "SMTP_SECURE" | "SMTP_USER" | "SMTP_PASSWORD" | "SMTP_FROM" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY" | "VAPID_SUBJECT">> {}
}
