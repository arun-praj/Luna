  ...
  return (
    <main className="page-route-enter h-dvh overflow-hidden bg-white text-foreground">
      <div className="mx-auto flex h-full min-h-0 w-full max-w-[520px] flex-col px-5 pb-5 sm:px-8">
        <StickyPageHeader className="-mx-5 w-[calc(100%+2.5rem)] shrink-0 flex items-center bg-white px-5 pb-3 sm:-mx-8 sm:w-[calc(100%+4rem)] sm:px-8 sm:pt-8">
          <Link href="/" aria-label="Go to Luna home" className="flex items-center gap-2 rounded-[10px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/35">
            <Image src="/icon-192.png" alt="" width={36} height={36} className="size-9 rounded-[10px] shadow-[0_4px_10px_rgb(53_107_104_/_0.16)]" />
        ...
        <section className="flex min-h-0 flex-1 flex-col justify-start overflow-hidden py-3 sm:justify-center sm:py-8">
          <div className="relative mx-auto w-full max-w-[320px]">
            <Image src="/budget-login-illustration-crop.png" alt="Wallet, coins, receipts, and other objects representing everyday budgeting" width={864} height={1200} priority className="h-auto max-h-[18vh] w-full object-contain min-[390px]:max-h-[20vh] sm:max-h-[300px]" />
          </div>
